...
format:
  pptx:
    reference-doc: template-mlops-clean.pptx
    monofont: "Cousine"
---
...
- In this short introduction, I want to give you a **map of the field**.
...
- Reinforcement learning is about learning through:
  ...
  - reward
  - trial and error
- In this course, the most realistic student projects are probably:
  - games
  - simulations
...
- Some students may focus less on training and more on **getting AI to run well on real hardware**.
